  ...
  return (
    <div className="contact-us-container">
        ...
        <div className="grid place-items-end">
          <div className="bg-white text-black font-semibold p-10">
            ...
            <div className="p-4">
              <button
                type="button"
                className="bg-teal-400 transition-all duration-300 rounded hover:bg-black pt-4 pb-4 pl-8 pr-8 uppercase text-xl text-white font-semibold"
              >
                Contact Us
              </button>
            </div>
      ...
      <div className="sticky-background">
        <img src="./imgs/banners/id1-banner2.jpg" alt="img" />
      </div>
    </div>
  );
};
